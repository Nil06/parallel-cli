...
const en: Record<string, string> = {
  ...
  'agent.resultTitle': 'Agent result',
  'agent.realChanges': 'Real changes',
  'agent.moreChanges': '+{count} more change(s) · see /diff',
  ...
  'timeline.hiddenPatches': '+{count} hidden patch(es) · /diff',
  ...
  'timeline.narration.inspectTarget': 'I inspect {target}.',
  'timeline.narration.changeTarget': 'I update {target} and show the patch.',
  'timeline.narration.validateCommand': 'I run {command} to validate the current changes.',
  'timeline.narration.publishCommand': 'I run {command} after checking the local state.',
  'timeline.narration.coordinateTarget': 'I handle the coordination signal: {target}.',
  'timeline.narration.resultTarget': 'I check the result: {target}.',
  'cmd.send': 'Alias for @Agent message',
  'cmd.pause': 'Pause',
  'cmd.resume': 'Resume',
  'cmd.stop': 'Stop',
  ...
  'attach.hint': 'plain text steers this agent · @all broadcasts · @agent routes · /task creates · /quit detaches',
  'attach.resultAppended': 'Result added above. Changes: {changes}',
...
const fr: Record<string, string> = {
  ...
  'agent.resultTitle': 'Résultat de l’agent',
  'agent.realChanges': 'Modifications réelles',
  'agent.moreChanges': '+{count} autre(s) changement(s) · voir /diff',
  ...
  'timeline.hiddenPatches': '+{count} patch(s) masqué(s) · /diff',
  ...
  'timeline.narration.inspectTarget': 'Je vérifie {target}.',
  'timeline.narration.changeTarget': 'Je modifie {target} et j’affiche le patch.',
  'timeline.narration.validateCommand': 'Je lance {command} pour valider les changements en cours.',
  'timeline.narration.publishCommand': 'Je lance {command} après avoir vérifié l’état local.',
  'timeline.narration.coordinateTarget': 'Je traite le signal de coordination : {target}.',
  'timeline.narration.resultTarget': 'Je vérifie le résultat : {target}.',
  'cmd.send': 'Alias de @Agent message',
  ...
  'attach.hint': 'texte libre pilote cet agent · @all diffuse · @agent route · /task crée · /quit détache',
  'attach.resultAppended': 'Résultat ajouté dans l’historique. Modifications : {changes}',
...
const es: Record<string, string> = {
  ...
  'timeline.narration.inspectTarget': 'Inspecciono {target}.',
  'timeline.narration.changeTarget': 'Modifico {target} y muestro el parche.',
  'timeline.narration.validateCommand': 'Ejecuto {command} para validar los cambios actuales.',
  'timeline.narration.publishCommand': 'Ejecuto {command} después de revisar el estado local.',
  'timeline.narration.coordinateTarget': 'Gestiono la señal de coordinación: {target}.',
  'timeline.narration.resultTarget': 'Reviso el resultado: {target}.',
...
const zh: Record<string, string> = {
  ...
  'timeline.narration.inspectTarget': '我检查 {target}。',
  'timeline.narration.changeTarget': '我修改 {target} 并显示补丁。',
  'timeline.narration.validateCommand': '我运行 {command} 来验证当前改动。',
  'timeline.narration.publishCommand': '我在检查本地状态后运行 {command}。',
  'timeline.narration.coordinateTarget': '我处理协调信号：{target}。',
  'timeline.narration.resultTarget': '我检查结果：{target}。',
